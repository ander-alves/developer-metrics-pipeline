...
// adapters that talk to AWS services. We do this in the application layer
// — on top of SQS's native redrive policy — so transient errors (network
// blips, throttling, brief LocalStack hiccups) are absorbed without
// burning attempts against maxReceiveCount and pushing the message to the
// DLQ prematurely.
package retry
